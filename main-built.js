...
var Puppets = function (config)
{
	...
	this.Components =
	{
		...
		addComponent : function(entity, component, constructor, enabled)
		{
			...
			else if(this.list[component][id].enabled !== false)
...
;
define("puppets", (function (global) {
    return function () {
        var ret, fn;
        return ret || global.puppets;
    };
}(this)));

define('../loader/libraries/puppets',["puppets"], function(){
	return new Puppets();
});
...
define('../loader/libraries/box2d',["box2d"], function(){
	return Box2D;
});
define('../puppetsModules/box2dPuppet',["../loader/libraries/box2d", "../loader/libraries/puppets"], function(Box2D, Puppets){
...
define('../puppetsModules/baseComponents',["../loader/libraries/puppets"], function(Puppets){
...
define('../puppetsModules/boxRendering',["../loader/libraries/puppets", "./baseComponents"], function(Puppets){
...
define('../puppetsModules/box2dInterface',["../loader/libraries/puppets", "./box2dPuppet", "./boxRendering"], function(Puppets){
...
define('../puppetsModules/circleRendering',["../loader/libraries/puppets", "./baseComponents"], function(Puppets){
...
define('../puppetsModules/mouseModule',["../loader/libraries/puppets", "./circleRendering"], function(Puppets){
...
define("Vectors", function(){});

define('../puppetsModules/boxCollision',["../loader/libraries/puppets", "Vectors"], function(Puppets, Vectors){
...
define('../puppetsModules/DOMmodule',["../loader/libraries/puppets"], function(Puppets){
...
define('../puppetsModules/boxCollisionColor',["../loader/libraries/puppets", "./DOMmodule"], function(Puppets){
...
define('../puppetsModules/brushModule',["../loader/libraries/puppets"], function(Puppets){
...
define('../puppetsModules/gaugeModule',["../loader/libraries/puppets"], function(Puppets){
...
define('../puppetsModules/dialogueModule',["../loader/libraries/puppets"], function(Puppets){
...
define('../puppetsModules/camera',["../loader/libraries/puppets", "./baseComponents", "./dialogueModule"], function(Puppets){
...
define('../game/canvas/pixelsManager',[], function(){
...
define('../game/constants',["./canvas/pixelsManager"], function(PIXELS_ARRAY){
	return {
		WIDTH : 2000,
		HEIGHT : 2000,
        PAINTWIDTH : 600,
...
define('../game/game',["./constants", "../loader/libraries/puppets", "./event"], function(constants, Puppets, EventController){
	var Game = function(){
...
define('../puppetsModules/platformTypes',["../game/game", "../loader/libraries/box2d", "../loader/libraries/puppets"], function(Game, Box2D, Puppets){
...
;
define('../puppetsModules/animationModules',["../loader/libraries/box2d", "../loader/libraries/puppets"], function(Box2D, Puppets){
...
define('../libraries/noise',[], function(){
    ...
    this.noise = function(x, y, z) {
       ...
       function grad(hash, x, y, z) {
        ...
        this.turbulence = function( x,y,z, octaves ) {
            var t = 0;
            var f = 1;
            var n = 0;
...
define('../puppetsModules/particle',["../loader/libraries/puppets", "../libraries/noise", "./circleRendering"], function(Puppets, Perlin){
...
define('../game/level/PNGParser',[], function(){
...
define('../game/level/parsingFunction',["../../loader/libraries/puppets", "../game"], function(Puppets, Game){
...
define('../puppetsModules/memories',["../loader/libraries/puppets", "../game/level/PNGParser", "../game/level/parsingFunction"], function(Puppets, PNGParser, parse){
...
define('../loader/loadModules',["../puppetsModules/box2dInterface",
...
define('../game/canvas/canvasCreator',["../../loader/libraries/puppets"], function(Puppets){
...
define('../game/canvas/canvasDimensionCreator',["../../loader/libraries/puppets", "./canvasCreator"], function(Puppets, CanvasCreator){
...
define('../game/mouse/config',[], function(constants){
	return {
		radius : 20, 
		circumference : 2,
...
define('../game/mouse/mouseController',["../../loader/libraries/puppets", "../game", "./config"], function(Puppets, Game, config){
...
define('../game/canvas/configMainCanvas',["../game", "../constants"],
...
define('../game/canvas/configFirstDimension',["../game"],
 function(Game){
	return {
		canvas : document.getElementById("buffer"),
	}
});
define('../game/canvas/canvasController',["../../loader/libraries/puppets", "../game", "./canvasDimensionCreator",
...
define('../game/UI/configColorGauge',["../game"],
 function(Game){
    return {
        position : {
            x : 570,
...
define('../game/UI/gaugeCreator',["../../loader/libraries/puppets"], function(Puppets){
...
define('../game/UI/UIController',["../../loader/libraries/puppets", "../game", "./configColorGauge", "./gaugeCreator"],
...
define('../game/camera/config',[], function(){
...
define('../game/camera/cameraController',["../../loader/libraries/puppets", "../game", "./config"], function(Puppets, Game, config){
...
define('../game/world/worldController',["../../loader/libraries/puppets", "../game", "./config"], function(Puppets, Game, config){
...
define('../game/level/levelController',["../../loader/libraries/puppets", "../game", "./PNGParser", "./parsingFunction"], function(Puppets, Game, PNGParser, parse){
...
define("keypress", (function (global) {
    return function () {
        var ret, fn;
        return ret || global.keypress;
    };
}(this)));
...
define("dancer", (function (global) {
    return function () {
        var ret, fn;
        return ret || global.dancer;
    };
}(this)));

define('../game/keyboard/keyboardController',["../../loader/libraries/puppets", "../game", "keypress", "dancer"], function(Puppets, Game, Keypress){
...
define('../game/player/config',["../game"], function(Game){
...
define('../game/player/playerController',["../../loader/libraries/puppets", "../game", "./config"], function(Puppets, Game, config){
...
define('../game/dialogue/config',["../game"], function(Game){
    var constants = Game.constants;
    return {
        dialogueOne : {
            delay : 3,
...
define('../game/dialogue/dialogueController',["../../loader/libraries/puppets", "../game", "./config"], function(Puppets, Game, config){
...
define('../game/menus/menuController',["../../loader/libraries/puppets", "../game"], function(Puppets, Game){
...
define('../loader/loadGame',["../game/game", "../game/canvas/canvasController", "../game/UI/UIController",
...
define('../main',["./loader/libraries/puppets",
