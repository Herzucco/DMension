;(function(undefined){
	Puppets.load("modules/completeModules/DOMmodule.js");
		...
		for(i = colorColliderBox.x >> 0; i < iWidth; i+=colorColliderBox.colorAccuracy){
			for(o = colorColliderBox.y >> 0; o < iHeight; o+=colorColliderBox.colorAccuracy){
				...
				if(color !== null && (color.r || color.g || color.b)){
					...
					colorColliderBox.onColorCollisionEnter.apply({ components : Puppets.getComponents(entity)[0], id : entity}, [color]);
					return;
				}
			}
		};
